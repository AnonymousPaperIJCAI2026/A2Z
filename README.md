...
| LAP | Sequential auxiliary/source domains only | No target data for training or tuning. | Maintain transferable anomaly semantics and local structures under continual auxiliary learning | Stage-wise zero-shot probing on strictly disjoint target domains, plus Forgetting/BWT |
